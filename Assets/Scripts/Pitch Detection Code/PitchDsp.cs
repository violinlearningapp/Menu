...
namespace PitchDetector
{
    ...
    class PitchDsp
    {
        ...
        /// <returns></returns>
        public static string GetNoteName(int note, bool sharps, bool showOctave, bool version)
        {
